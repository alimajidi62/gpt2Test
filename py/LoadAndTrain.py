...
with open("augmented_qa_dataset.json", "w", encoding="utf-8") as file:
    json.dump(augmented_data, file, indent=2)

# ======= Step 2: Tokenize Data for GPT-2 Fine-Tuning =======
tokenizer = GPT2Tokenizer.from_pretrained("gpt2")
tokenizer.pad_token = tokenizer.eos_token

train_texts = [f"Q: {item['question']} A: {item['answer']}" for item in augmented_data]
...
training_args = TrainingArguments(
    output_dir="./gpt2-finetuned-resume-qa",
    num_train_epochs=10,
...
model.save_pretrained("./gpt2-finetuned-resume-qa")
tokenizer.save_pretrained("./gpt2-finetuned-resume-qa")
print("Model saved!")
